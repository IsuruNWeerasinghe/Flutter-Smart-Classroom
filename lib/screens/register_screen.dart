            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                CommonRoundedTextField(
                  hintText: AppStrings.child_name,
                  textType: TextInputType.name,
                  icon: Icons.person,
                  controller: ctrlChildName,
                  validate: validateChildName,
                  onChanged: (val){
                    setState(() {
                      FormValidation.isName(ctrlChildName.text) ? validateChildName = false : validateChildName =true;
                    });
                  },
                ...
                validateChildName == true ? const Align(
                ...
                CommonRoundedButton(
                  ...
                  onPressed: () async{
                    setState(() {
                      ...
                      if (ctrlChildName.text.isEmpty){
                        validateChildName = true;
                      }
                    ...
                    if ((ctrlPassword.text == ctrlConfirmPassword.text) && (validateChildName == false) && (validateEmail == false) && (validatePassword == false)) {
                ...
                Row(
                    ...
                    children: <Widget>[
                      FlatButton(
                        ...
                        onPressed: (){
                          Navigator.popAndPushNamed(context, Routes.welcome_page);
                        },
                        child: Row(
