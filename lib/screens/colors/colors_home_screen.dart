...
class ColorsHomeScreen extends StatelessWidget {
  static const String routeName = '/colors_home_page';
  const ColorsHomeScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    List<Color> colors = [AppColors.pink, AppColors.green];
    List<String> topics = [AppStrings.colours, AppStrings.quiz1];
    List<String> routes = [Routes.colors_page, Routes.colors_quiz_page];
    List<String> images = ["home icons/home_colors.png", "alphabet/alphabet_quiz_2.png"];
